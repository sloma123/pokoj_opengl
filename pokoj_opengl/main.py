...
from furniture import Komoda, Stol, TV, Regal, Szafa, Lozko, Koldra

# Kamera – przy suficie, z tyłu, patrzy lekko w dół i do przodu
#camera_pos = np.array([0.0, 2.4, -3.9])
#camera_front = np.array([0.0, -0.3, 1.0])
camera_pos = np.array([0.0, 1.6, 4.0]) #tablica położenia kamert (x,y,z)
